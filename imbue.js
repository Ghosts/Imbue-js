...
HTMLElement.prototype.removeStyle = function (styles) {
...
HTMLElement.prototype.getSiblings = function () {
    ...
    do { isiblings.push(el); } while (el = el.nextSibling);
    return siblings;
};
...
HTMLElement.prototype.getSelectedValue = function () {
    ...
    return !checked ? (checked.options[checked.selectedIndex] ? checked.options[checked.selectedIndex] : undefined) : undefined;
};
